...
const Datenschutz = () => {
  return (
    <div style={{ background: "white", color: "black" }} className='daten'>
      ...
      <p>
        Eine &Uuml;bersicht &uuml;ber die Facebook Social-Media-Elemente finden
        Sie hier:{" "}
        <a
      ...
      <p>
        ...
        Canal Harbour, Dublin 2, Irland gemeinsam f&uuml;r diese
        ...
        verarbeiteten Daten k&ouml;nnen Sie direkt bei Facebook geltend machen.
